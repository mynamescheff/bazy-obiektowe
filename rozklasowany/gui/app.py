...
from tkinter import ttk, messagebox, filedialog, Text, BooleanVar, W, E, N, S
import threading
import os
import sqlite3
from rozklasowany.modules.outlook_processor import OutlookProcessor
from rozklasowany.modules.case_list import CaseList
from rozklasowany.modules.excel_transposer import ExcelTransposer
...
class ExcelProcessorApp:
    ...
    def add_to_database(self):
        try:
            ...
            if success:
                messagebox.showinfo("Success", "Data added to database successfully.")
